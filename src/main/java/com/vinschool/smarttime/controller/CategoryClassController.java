...
public class CategoryClassController {
    ...
    @GetMapping("/save{id}")
    public String CreateOrUpdate(Model model, @RequestParam(name = "id", required = false) String id,
    ...
    @PostMapping("/save")
    public String Save(@ModelAttribute("category") CategoryClass categoryClass,
